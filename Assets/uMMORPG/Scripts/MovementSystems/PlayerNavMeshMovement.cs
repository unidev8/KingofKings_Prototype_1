...
public class PlayerNavMeshMovement : NavMeshMovement
{
    ...
    void TestAttack_Q()
    {
        ...
        //foreach (Animator animator in GetComponentsInChildren<Animator>())
        {
            animator.SetTrigger("Skill_Q"); // smooth idle<->run transitions                                                                                                         //animator.SetBool("OnGround", true); //player.mountControl.activeMount == null);
        }       
    }
    ...
    void TestAttack_E()
    {
        ...
        //foreach (Animator animator in GetComponentsInChildren<Animator>())
        {
            animator.SetTrigger("Skill_E"); // smooth idle<->run transitions                                                                                                         //animator.SetBool("OnGround", true); //player.mountControl.activeMount == null);
        }        
    }
    ...
    void TestAttack_Z()
    {
        ...
        //foreach (Animator animator in GetComponentsInChildren<Animator>())
        {
            animator.SetTrigger("Skill_Z"); // smooth idle<->run transitions                                                                                                         //animator.SetBool("OnGround", true); //player.mountControl.activeMount == null);
        }
    }
    ...
    void TestAttack_C()
    {
        ...
        //foreach (Animator animator in GetComponentsInChildren<Animator>())
        {
            animator.SetTrigger("Skill_C"); // smooth idle<->run transitions                                                                                                         //animator.SetBool("OnGround", true); //player.mountControl.activeMount == null);
        }
    }
